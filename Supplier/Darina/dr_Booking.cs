...
namespace TravillioXMLOutService.Supplier.Darina
{
    ...
    {        
        ...
        private IEnumerable<XElement> GetHotelPassengersInfo(List<XElement> htpassengersinfo)
        {
            ...
            for (int i = 0; i < htpassengersinfo.Count(); i++)
            {
                          ...
                          "<soap:Body>" +
                            "<SubmitBooking_Accomodation xmlns='http://travelcontrol.softexsw.us/'>" +
                             ...
                             "<AgentID>" + AgentID + "</AgentID>" +
                              ...
                              "<Passengers>" + ss2 +
                              "</Passengers>" +
                              "<RequestID>" + req.Descendants("Room").FirstOrDefault().Descendants("RequestID").FirstOrDefault().Value + "</RequestID>" +   //903|636|1|7|0|945|T|F|1|0
                              "<IsTest>false</IsTest>" +
