    ...
    public class RTS_HTlBooking
    {
        ...
        public XElement HtlBooking(XElement req, string GuestCountyCode)
        {
            ...
            try
            {
                ...
                XDocument ele = obj.HttpPostRequestbook(RTSBokCXlURL, lst.FirstOrDefault().ToString(), req, "Book", 5);
            ...
            catch(Exception ex)
            {
                ...
                ex1.MethodName = "HtlBooking";
                ex1.PageName = "RTS_HTlBooking";
            ...
            XElement confirmedBookingerr2 = new XElement(
                                               new XElement(soapenv + "Envelope",
                                                   new XAttribute(XNamespace.Xmlns + "soapenv", soapenv),
                                                   new XElement(soapenv + "Header",
                                                       new XElement("Authentication",
                                                   ...
                                                   new XElement(soapenv + "Body",
                                                       new XElement(req.Descendants("HotelBookingRequest").First()),
                                                        new XElement("HotelBookingResponse",
                                                           new XElement("ErrorTxt", Convert.ToString("Kindly contact to Admin.")))
                                                      )));
            return confirmedBookingerr2;
        }
