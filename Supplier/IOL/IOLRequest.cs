...
{
    public class IOLRequest : IDisposable
    {
        public XDocument Request(XElement req, string url, string genguid, IOLLogModel model)
        {
            //var client = new HttpClient();
            //var request = new HttpRequestMessage(HttpMethod.Post, "https://api.iwtxconnect.com/hotel/api/v1/search");
            //var content = new StringContent("<HotelSearchRequest></HotelSearchRequest>", null, "text/plain");
