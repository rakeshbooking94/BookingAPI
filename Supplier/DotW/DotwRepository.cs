...
namespace TravillioXMLOutService.Supplier.DotW
{
    public class DotwRepository : IDisposable
    {
        ...
        public XDocument GetResponse_search(XDocument requestXml, Client model)
        {
            ...
            catch (Exception ex)
            {
                ...
                custEx.PageName = "GetResponse_search";
        ...
        public XDocument GetResponse_room(XDocument requestXml, Client model)
        {
            var startTime = DateTime.Now;
            string response = string.Empty;
            XDocument Responsexml = new XDocument(new XElement("result", "request Initialize"));
        ...
        public string GetXml(Client model)
        {
            ...
            var hotelId = new SqlParameter();
            hotelId.ParameterName = "@HotelId";
            hotelId.Direction = ParameterDirection.Input;
            hotelId.SqlDbType = SqlDbType.BigInt;
            hotelId.Value = model.HotelId;
            pList[5] = hotelId;
        ...
        public string GetXml_cancel(Client model)
        {
            string code = string.Empty;
            ...
            DataTable result = DotwDataAcess.Get("dotwProc_cancel", pList);
            code = result.Rows[0]["logresponseXML"].ToString().Trim();
        ...
        public string GetRoomPrice(Client model, string xmlDoc)
        {
            ...
            SqlParameter[] pList = new SqlParameter[7];
            var flag = new SqlParameter();
            flag.ParameterName = "@flag";
            flag.Direction = ParameterDirection.Input;
            flag.SqlDbType = SqlDbType.Int;
