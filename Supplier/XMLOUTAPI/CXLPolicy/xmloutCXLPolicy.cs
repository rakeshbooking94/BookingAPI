...
namespace TravillioXMLOutService.Supplier.XMLOUTAPI.CXLPolicy
{
    public class xmloutCXLPolicy : IDisposable
    {
        ...
        public XElement cxlpolicy_beOUT(XElement req,int suppID)
        {
            ...
            try
            {
                ...
                string apiresponse = apireq.xmloutHTTPResponse(request, "CXLPolicy", 3, req.Descendants("TransID").FirstOrDefault().Value, customerid, Convert.ToString(SupplierId));
