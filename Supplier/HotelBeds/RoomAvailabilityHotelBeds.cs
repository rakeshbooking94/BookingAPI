            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < length; i++)
                    {
                        ...
                        promotion.Add(new XElement("Promotions", Convert.ToString(roompromotions[i].Attribute("name") == null ? roompromotions[i].Attribute("code").Value : roompromotions[i].Attribute("name").Value)));
