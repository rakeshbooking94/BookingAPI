            ...
            if (headercheck.Headervalidate(username, password, AgentID, ServiceType, ServiceVersion) == true)
            {
                ...
                try
                {
                    ...
                    if (supplierid == "27")
                    {
                        ...
                        XElement hotelcxlpolicy = rs.getCXLpolicy(req);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "44")
                    {
                        ...
                        XElement CancellationPolicy = reqwl.CancellationPolicy(req);
                        return CancellationPolicy;
                    }
                    #endregion
                    #region Hoojoozat
                    ...
                    if (supplierid == "48")
                    {
                        ...
                        XElement CancellationPolicy = wteobj.CancellationPolicy(req);
                        return CancellationPolicy;
                    }
                    #endregion
                    #region IOL
                    if (supplierid == "50")
                    {
                        ...
                        XElement CancellationPolicy = iolobj.CancellationPolicy(req);
                        return CancellationPolicy;
                    }
                    #endregion
                    ...
                    if (supplierid == "501")
                    {
                        ...
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 501);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "502")
                    {
                        #region ETripCenter
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req,502);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "503")
                    {
                        #region Holidays Arabia
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 503);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "504")
                    {
                        #region Novo Destino
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 504);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "533")
                    {
                        #region Plaza
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 533);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "534")
                    {
                        #region CBH
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 534);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "627")
                    {
                        #region Adventures
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 627);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "628")
                    {
                        #region GTSBeds
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 628);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "629")
                    {
                        #region H2GO
                        xmloutCXLPolicy rs = new xmloutCXLPolicy();
                        XElement hotelcxlpolicy = rs.cxlpolicy_beOUT(req, 629);
                        return hotelcxlpolicy;
                        #endregion
                    }
                    #endregion
