            ...
            if (headercheck.Headervalidate(username, password, AgentID, ServiceType, ServiceVersion) == true)
            {
                ...
                try
                {
                    ...
                    if (supplierid == "27")
                    {
                        ...
                        XElement hotelcxlresponse = rs.CancelBookingGoGlobal(req);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "44")
                    {
                        ...
                        XElement BookingCancellation = reqwl.BookingCancellation(req);
                        return BookingCancellation;
                    }
                    #endregion
                    #region Hoojoozat
                    ...
                    if (supplierid == "48")
                    {
                        ...
                        XElement BookingCancellation = wteobj.CancelBooking(req);
                        return BookingCancellation;
                    }
                    #endregion
                    #region IOL
                    if (supplierid == "50")
                    {
                        ...
                        XElement BookingCancellation = iolobj.CancelBooking(req);
                        return BookingCancellation;
                    }
                    #endregion
                    ...
                    if (supplierid == "501")
                    {
                        ...
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 501);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "502")
                    {
                        #region ETripCenter
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 502);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "503")
                    {
                        #region Holidays Arabia
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 503);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "504")
                    {
                        #region Novo Destino
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 504);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "533")
                    {
                        #region Plaza
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 533);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "534")
                    {
                        #region CBH
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 534);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "627")
                    {
                        #region Adventures
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 627);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "628")
                    {
                        #region GTSBeds
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 628);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "629")
                    {
                        #region H2GO
                        xmloutCancel rs = new xmloutCancel();
                        XElement hotelcxlresponse = rs.cancel_bookingexpressOUT(req, 629);
                        return hotelcxlresponse;
                        #endregion
                    }
                    #endregion
