            ...
            if (headercheck.Headervalidate(username, password, AgentID, ServiceType, ServiceVersion) == true)
            {
                ...
                try
                {
                    ...
                    if (supplierid == "20")
                    {
                        ...
                        XElement bookingres = expobj.HotelBooking(req);
                        return bookingres;
                    }
                    #endregion
                    #region TBO Holidays
                    ...
                    if (supplierid == "27")
                    {
                        ...
                        XElement bookingres = rs.BookingResponse_GoGlobal(req);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "44")
                    {
                        ...
                        XElement bookingres = reqwl.HotelBooking(req);
                        return bookingres;
                    }
                    #endregion
                    #region Hoojoozat
                    ...
                    if (supplierid == "48")
                    {
                        ...
                        XElement bookingResponse = wteob.Booking(req);
                        return bookingResponse;
                    }
                    #endregion
                    #region IOL
                    if (supplierid == "50")
                    {
                        ...
                        XElement bookingResponse = iolob.Booking(req);
                        return bookingResponse;
                    }
                    #endregion
                    ...
                    if (supplierid == "501")
                    {
                        ...
                        XElement bookingres = rs.book_bookingexpressOUT(req,501);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "502")
                    {
                        #region ETripCenter
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req,502);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "503")
                    {
                        #region Holidays Arabia
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req,503);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "504")
                    {
                        #region Novo Destino
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req,504);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "533")
                    {
                        #region Plaza
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req, 533);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "534")
                    {
                        #region CBH
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req, 534);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "627")
                    {
                        #region Adventures
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req, 627);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "628")
                    {
                        #region GTSBeds
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req, 628);
                        return bookingres;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "629")
                    {
                        #region H2GO
                        xmloutBook rs = new xmloutBook();
                        XElement bookingres = rs.book_bookingexpressOUT(req, 629);
                        return bookingres;
                        #endregion
                    }
                    #endregion
