            ...
            if (headercheck.Headervalidate(username, password, AgentID, ServiceType, ServiceVersion) == true)
            {
                ...
                try
                {
                    ...
                    if (supplierid == "16")
                    {
                        ...
                        XElement htdetails = rs.hoteldetails(req,16);
                        return htdetails;
                    }
                    #endregion
                    #region EgyptExpress
                    if (supplierid == "17")
                    {
                        int customerid = Convert.ToInt32(req.Descendants("CustomerID").Single().Value);
                        JuniperResponses rs = new JuniperResponses();
                        XElement htdetails = rs.hoteldetails(req,17);
                        return htdetails;
                    }
                    #endregion
                    #region Sal Tours
                    ...
                    if (supplierid == "23")
                    {
                        int customerid = Convert.ToInt32(req.Descendants("CustomerID").Single().Value);
                        JuniperResponses rs = new JuniperResponses();
                        XElement htdetails = rs.hoteldetails(req,23);
                        return htdetails;
                    }
                    #endregion
                    #region GoGlobal
                    if (supplierid == "27")
                    {
                        ...
                        XElement htdetails = rs.HotelDetailGoGlobal(req);
                        return htdetails;
                    }
                    #endregion
                    #region Cosmobeds
                    if (supplierid == "29")
                    {
                        ...
                        XElement hotelDetails = tgs.HotelDetail(req,29);
                        return hotelDetails;
                    }
                    #endregion
                    #region Stuba
                    ...
                    {
                        TGServices tgs = new TGServices();
                        XElement hotelDetails = tgs.HotelDetail(req, 30);
                        return hotelDetails;
                    }
                    #endregion
                    #region Gadou
                    if (supplierid == "31")
                    {
                        ...
                        int customerid = Convert.ToInt32(req.Descendants("CustomerID").Single().Value);
                        JuniperResponses rs = new JuniperResponses();
                        XElement htdetails = rs.hoteldetails(req,31);
                        return htdetails;
                    }
                    #endregion
                    #region YALAGO
                    ...
                    {
                        TGServices tgs = new TGServices();
                        XElement hotelDetails = tgs.HotelDetail(req, 32);
                        return hotelDetails;
                    }
                    #endregion
                    #region LCI
                    if (supplierid == "35")
                    {
                        int customerid = Convert.ToInt32(req.Descendants("CustomerID").Single().Value);
                        JuniperResponses rs = new JuniperResponses();
                        XElement htdetails = rs.hoteldetails(req,35);
                        return htdetails;
                    }
                    #endregion                   
                    #region SunHotels
                    if (supplierid == "36")
                    {
                        ...
                        XElement htdetails = objRs.hoteldetails(req, 36);
                        return htdetails;
                    }
                    #endregion
                    #region Total Stay
                    ...
                    {
                        TGServices tgs = new TGServices();
                        XElement hotelDetails = tgs.HotelDetail(req,39);
                        return hotelDetails;
                    }
                    #endregion
                    #region AlphaTours
                    if (supplierid == "41")
                    {
                        int customerid = Convert.ToInt32(req.Descendants("CustomerID").Single().Value);
                        JuniperResponses rs = new JuniperResponses();
                        XElement htdetails = rs.hoteldetails(req,41);
                        return htdetails;
                    }
                    #endregion
                    #region WelcomeBeds
                    if (supplierid == "44")
                    {
                        ...
                        XElement hotelDetails = reqwl.HotelDescription(req);
                        return hotelDetails;
                    }
                    #endregion
                    #region Hoojoozat
                    ...
                    if (supplierid == "48")
                    {
                        WTEService wwte = new WTEService();
                        XElement hotelDetails = wwte.HotelDetail(req, 48);
                        return hotelDetails;
                    }
                    #endregion
                    #region IOL
                    if (supplierid == "50")
                    {
                        IOLService iolobj = new IOLService();
                        XElement hotelDetails = iolobj.HotelDetail(req, 50);
                        return hotelDetails;
                    }
                    #endregion
                    #region XML OUT
