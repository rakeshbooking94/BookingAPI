            ...
            if (headercheck.Headervalidate(username, password, AgentID, ServiceType, ServiceVersion) == true)
            {
                try
                {
                    ...
                    if (supplierid == "29")
                    {
                        ...
                        TGServices tgs = new TGServices(29, req.Descendants("CustomerID").FirstOrDefault().Value);
                    ...
                    if (supplierid == "30")
                    {
                        ...
                        TGServices tgs = new TGServices(30, req.Descendants("CustomerID").FirstOrDefault().Value);
                        XElement prebookres = tgs.PreBook(req, custName);
                        return prebookres;
                    }
                    #endregion
                    ...
                    if (supplierid == "32")
                    {
                        ...
                        TGServices tgs = new TGServices(32, req.Descendants("CustomerID").FirstOrDefault().Value);
                        XElement prebookres = tgs.PreBook(req, custName);
                        return prebookres;
                    }
                    #endregion
                    ...
                    if (supplierid == "44")
                    {
                        if (custName == "")
                        {
                            custName = "WelcomeBeds";
                        }
                        string customerid = req.Descendants("CustomerID").Single().Value;
                        WelcomebedsService reqwl = new WelcomebedsService(customerid);
                        XElement prebookres = reqwl.PreBooking(req, custName);
                        return prebookres;
                    }
                    #endregion
                    #region Hoojoozat
                    ...
                    if (supplierid == "48")
                    {
                        if (custName == "")
                        {
                            custName = "Withinearth";
                        }
                        WTEService wteob = new WTEService(req.Descendants("CustomerID").FirstOrDefault().Value);
                        XElement prebookres = wteob.PreBook(req, custName);
                        return prebookres;
                    }
                    #endregion
                    #region IOL
                    if (supplierid == "50")
                    {
                        ...
                        IOLService iolob = new IOLService(req.Descendants("CustomerID").FirstOrDefault().Value);
                        XElement prebookres = iolob.PreBook(req, custName);
                        return prebookres;
                    }
                    #endregion
                    ...
                    if (supplierid == "501")
                    {
                        ...
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 501);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "502")
                    {
                        ...
                        if (custName == "")
                        {
                            custName = "ETripCenter";
                        }
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 502);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion 
                    ...
                    if (supplierid == "503")
                    {
                        ...
                        if (custName == "")
                        {
                            custName = "HolidaysArabia";
                        }
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 503);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion 
                    ...
                    if (supplierid == "504")
                    {
                        ...
                        if (custName == "")
                        {
                            custName = "NovoDestino";
                        }
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 504);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "533")
                    {
                        ...
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 533);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "534")
                    {
                        ...
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 534);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "627")
                    {
                        ...
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 627);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "628")
                    {
                        ...
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 628);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
                    ...
                    if (supplierid == "629")
                    {
                        ...
                        xmlprebook objreq = new xmlprebook();
                        XElement hotelpreBooking = objreq.prebook_bookingexpressOUT(req, custName, 629);
                        return hotelpreBooking;
                        #endregion
                    }
                    #endregion
