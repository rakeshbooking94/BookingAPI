    ...
    public class TouricoRoomAvail
    {
        ...
        public IEnumerable<XElement> GetHotelRoomListingTourico(Tourico.RoomType roomlist, XElement reqTravillio)
        {
            ...
            if (totalroom == 1)
            {
                ...
                for (int i = 0; i < roomlist.Occupancies.Count(); i++)
                {
                    //Parallel.For(0, roomlist.Occupancies[i].Rooms.Count(), j =>
                    for (int j = 0; j < roomlist.Occupancies[i].Rooms.Count(); j++)
                    {
                ...
                for (int m = 0; m < roomList1.Count(); m++)
                {
                    ...
                    else
                    {
                        ...
                        for (int j = 0; j < bb; j++)
                        {
                            ...
                            for (int jj = 0; jj < roomList1[m].PriceBreakdown.Count(); jj++)
                            {
                    ...
                    for (int n = 0; n < roomList2.Count(); n++)
                    {
                        ...
                        else
                        {
                            ...
                            for (int j = 0; j < bb; j++)
                            {
                                ...
                                for(int jj=0;jj<roomList2[n].PriceBreakdown.Count();jj++)
                                {
                        ...
                        for (int o = 0; o < roomList3.Count(); o++)
                        {
                            ...
                            else
                            {
                                ...
                                for (int j = 0; j < bb; j++)
                                {
                                    ...
                                    for(int jj=0;jj<roomList3[o].PriceBreakdown.Count();jj++)
                                    {
                            ...
                            for (int p = 0; p < roomList4.Count(); p++)
                            {
                                ...
                                else
                                {
                                    ...
                                    for (int j = 0; j < bb; j++)
                                    {
                                        ...
                                        for (int jj = 0; jj < roomList4[p].PriceBreakdown.Count(); jj++)
                                        {
                                ...
                                for (int q = 0; q < roomList5.Count(); q++)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        for (int j = 0; j < bb; j++)
                                        {
                                            ...
                                            for (int jj = 0; jj < roomList5[q].PriceBreakdown.Count(); jj++)
                                            {
        ...
        private IEnumerable<XElement> GetRoomsPriceBreakupTourico(List<Tourico.Price> pricebreakups, decimal mealprice)
        {
            ...
            for (int j = 0; j < pricebreakups.Count(); j++)
            {
