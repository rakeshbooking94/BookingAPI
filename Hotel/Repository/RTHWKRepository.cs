...
namespace TravillioXMLOutService.Hotel.Repository
{
    internal class RTHWKRepository : IRTHWKRepository, IDisposable
    {
        ...
        public async Task<string> PreBookingAsync(RequestModel reqModel)
        {
            var startTime = DateTime.Now;
            APILogDetail log = new APILogDetail();
            string response = string.Empty;
            ...
            {
                CustomException custEx = new CustomException(ex);
                custEx.MethodName = "PreBookingAsync Issue while reading response";
                custEx.PageName = "RTHWKRepository";
                custEx.CustomerID = reqModel.Customer.ToString();
                custEx.TranID = reqModel.TrackNo;
                SaveAPILog apilog = new SaveAPILog();
            ...
            finally
            {
                ...
                {
                    CustomException custEx = new CustomException(ex);
                    custEx.MethodName = "PreBookingAsync Error on saving apilog";
                    custEx.PageName = "RTHWKRepository";
                    custEx.CustomerID = log.customerID.ToString();
                    custEx.TranID = log.TrackNumber;
                    SaveAPILog apilog = new SaveAPILog();
        ...
        public async Task<string> CancellationPolicyAsync(RequestModel reqModel)
        {
            ...
            try
            {
                ...
                using (var request = new HttpRequestMessage(HttpMethod.Post, "search/lookuprate"))
                {
                    request.Content = new StringContent(reqModel.RequestStr);
                    request.Content.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                    var result = await _httpClient.SendAsync(request);
            ...
            {
                CustomException custEx = new CustomException(ex);
                custEx.MethodName = "CancellationPolicy Issue while reading response";
                custEx.PageName = "RTHWKRepository";
                custEx.CustomerID = reqModel.Customer.ToString();
                custEx.TranID = reqModel.TrackNo;
                SaveAPILog apilog = new SaveAPILog();
            ...
            finally
            {
                ...
                {
                    CustomException custEx = new CustomException(ex);
                    custEx.MethodName = "CancellationPolicy Error on saving apilog";
                    custEx.PageName = "RTHWKRepository";
                    custEx.CustomerID = log.customerID.ToString();
                    custEx.TranID = log.TrackNumber;
                    SaveAPILog apilog = new SaveAPILog();
        ...
        public async Task<string> CancelBookingAsync(RequestModel reqModel)
        {
            var startTime = DateTime.Now;
            APILogDetail log = new APILogDetail();
            string response = string.Empty;
            try
            {
                ...
                using (var request = new HttpRequestMessage(HttpMethod.Post, "hotel/order/cancel/"))
                {
                    request.Content = new StringContent(reqModel.RequestStr);
                    request.Content.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                    var result = await _httpClient.SendAsync(request);
            ...
            {
                CustomException custEx = new CustomException(ex);
                custEx.MethodName = "CancelBookingAsync Issue while reading response";
                custEx.PageName = "RTHWKRepository";
                custEx.CustomerID = reqModel.Customer.ToString();
                custEx.TranID = reqModel.TrackNo;
                SaveAPILog apilog = new SaveAPILog();
            ...
            finally
            {
                ...
                {
                    CustomException custEx = new CustomException(ex);
                    custEx.MethodName = "CancelBookingAsync Error on saving apilog";
                    custEx.PageName = "RTHWKRepository";
                    custEx.CustomerID = log.customerID.ToString();
                    custEx.TranID = log.TrackNumber;
                    SaveAPILog apilog = new SaveAPILog();
        ...
        public async Task<string> HotelBookingCheckStatusAsync(RequestModel reqModel)
        {
            var startTime = DateTime.Now;
            APILogDetail log = new APILogDetail();
            string response = string.Empty;
            try
            {
                ...
                using (var request = new HttpRequestMessage(HttpMethod.Post, "hotel/order/booking/finish/status"))
                {
                    request.Content = new StringContent(reqModel.RequestStr);
                    request.Content.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                    var result = await _httpClient.SendAsync(request);
            ...
            {
                CustomException custEx = new CustomException(ex);
                custEx.MethodName = "HotelBookingCheckStatusAsync Issue while reading response";
                custEx.PageName = "RTHWKRepository";
                custEx.CustomerID = reqModel.Customer.ToString();
                custEx.TranID = reqModel.TrackNo;
                SaveAPILog apilog = new SaveAPILog();
            ...
            finally
            {
                ...
                {
                    CustomException custEx = new CustomException(ex);
                    custEx.MethodName = "HotelBookingCheckStatusAsync Error on saving apilog";
                    custEx.PageName = "RTHWKRepository";
                    custEx.CustomerID = log.customerID.ToString();
                    custEx.TranID = log.TrackNumber;
                    SaveAPILog apilog = new SaveAPILog();
